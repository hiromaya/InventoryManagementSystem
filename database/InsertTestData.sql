...
-- 2025-06-19の売上データ
('TEST_SALES_001', 1, '00001', '001', '001', '1001', 'テスト荷印A1', '51', '1', 'S20250619001', '2025-06-19', '2025-06-19', 'C001', 'テスト得意先A', 20.00, 1100.00, 22000.00, 1000.00),
('TEST_SALES_001', 2, '00002', '002', '001', '1001', 'テスト荷印A1', '51', '1', 'S20250619001', '2025-06-19', '2025-06-19', 'C001', 'テスト得意先A', 15.00, 1300.00, 19500.00, 1200.00),
('TEST_SALES_002', 1, '00011', '001', '001', '2001', 'テスト荷印B1', '51', '1', 'S20250619002', '2025-06-19', '2025-06-19', 'C002', 'テスト得意先B', 50.00, 900.00, 45000.00, 800.00),
('TEST_SALES_003', 1, '00021', '001', '001', '3001', 'テスト荷印C1', '51', '1', 'S20250619003', '2025-06-19', '2025-06-19', 'C003', 'テスト得意先C', 100.00, 700.00, 70000.00, 600.00),

-- 売上返品データ
('TEST_SALES_004', 1, '00001', '001', '001', '1001', 'テスト荷印A1', '52', '1', 'SR20250619001', '2025-06-19', '2025-06-19', 'C001', 'テスト得意先A', 5.00, 1100.00, 5500.00, 1000.00),

-- アンマッチテストデータ（存在しない商品）
('TEST_SALES_ERR_001', 1, '99999', '999', '999', '9999', '存在しない荷印', '51', '1', 'SE20250619001', '2025-06-19', '2025-06-19', 'C999', '該当無エラー用得意先', 10.00, 1000.00, 10000.00, 0.00),
-- アンマッチテストデータ（在庫マスタに存在しない組み合わせ）
('TEST_SALES_ERR_002', 1, '00001', '999', '999', '9999', '不正な組み合わせ', '51', '1', 'SE20250619002', '2025-06-19', '2025-06-19', 'C999', '該当無エラー用得意先', 5.00, 1000.00, 5000.00, 0.00);

PRINT 'SalesVouchers テストデータを投入しました（7件）';
...
-- 2025-06-19の仕入データ
('TEST_PURCHASE_001', 1, '00001', '001', '001', '1001', 'テスト荷印A1', '11', '1', 'P20250619001', '2025-06-19', '2025-06-19', 'S001', 'テスト仕入先A', 150.00, 950.00, 142500.00),
('TEST_PURCHASE_001', 2, '00002', '002', '001', '1001', 'テスト荷印A1', '11', '1', 'P20250619001', '2025-06-19', '2025-06-19', 'S001', 'テスト仕入先A', 100.00, 1150.00, 115000.00),
('TEST_PURCHASE_002', 1, '00011', '001', '001', '2001', 'テスト荷印B1', '11', '1', 'P20250619002', '2025-06-19', '2025-06-19', 'S002', 'テスト仕入先B', 200.00, 750.00, 150000.00),

-- 仕入返品データ
('TEST_PURCHASE_003', 1, '00021', '001', '001', '3001', 'テスト荷印C1', '12', '1', 'PR20250619001', '2025-06-19', '2025-06-19', 'S003', 'テスト仕入先C', 10.00, 550.00, 5500.00);
